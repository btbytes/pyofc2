...
docs = [
    ...
    <p>See this demo django app <a href="http://github.com/btbytes/djofc2_demo/tree/master">code</a> for a simple example of how to use PyOFC2 with the <a href="http://djangoproject.com/">Django</a> web framework.</p>
    ''' },
    ]
